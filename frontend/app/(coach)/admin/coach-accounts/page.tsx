// app/(coach)/admin/coach-accounts/page.tsx — Coach account access (activate / deactivate)
...
export default function AdminCoachAccountsPage() {
    ...
    return (
      <div className="flex min-h-[min(50vh,400px)] items-center justify-center py-16">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-medium text-muted-foreground">Loading accountsÔÇª</p>
        </div>
      </div>
    );
  }
