...
export function WelcomeModal() {
  ...
  const screens = [
    { title: 'Welcome to Torus Chess!', subtitle: "Let's start your chess adventure!", content: "🎉 Get ready to become a chess master with fun quests, puzzles, and games designed just for you!", emoji: '♟️' },
