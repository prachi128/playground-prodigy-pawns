    ...
    <div className="mx-auto max-w-5xl pb-12">
      ...
      <div className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <Link
            href="/dashboard"
            className="flex items-center gap-1.5 rounded-2xl bg-white px-4 py-3 font-heading text-base font-bold text-gray-800 shadow-md transition-all hover:scale-[1.02] hover:shadow-lg border border-gray-200"
          >
